...
int main() {
    ...
    float overtime_hours = a - BASE_HOURS;               // Часы сверх 38
    float overtime_rate = x * OVERTIME_COEF;             // Ставка за сверхурочный час
    float overtime_pay = overtime_hours * overtime_rate; // Оплата сверхурочных
